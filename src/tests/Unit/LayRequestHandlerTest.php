...
class LayRequestHandlerTest extends TestCase {
    public function setUp(): void
    {
        parent::setUp(); // TODO: Change the autogenerated stub
        $_SERVER['REQUEST_METHOD'] = "GET";
        LayRequestHandler::use_php_exception();
    }
//
//    /**
//     * @test
...
//    }
    ...
    public function request_with_similar_routes() : void {
        ...
        $req->group("admin", function(LayRequestHandler $req) use ($ctrl) {
    ...
    public function set_group_with_name() : void {
        ...
        $req->prefix("admin")
            ->group("users", function(LayRequestHandler $req) use ($ctrl) {
    ...
    public function set_group_without_name() : void {
        ...
        $req->prefix("admin")
            ->groups(function(LayRequestHandler $req) use ($ctrl) {
                $req->post('{d}/{b}')->bind(fn($a, $b) => $ctrl->print_user($a, $b))
                    ->get('profile/all')->bind(fn() => $ctrl->print_all())
                    ->post('cart/orders')->bind(fn() => $ctrl->void_method());
            });
